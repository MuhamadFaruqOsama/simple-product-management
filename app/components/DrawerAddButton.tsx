...
export function DrawerAddButton() {
    ...
    return (
        <Dialog>
            <DialogTrigger>
                <div className="w-14 h-14 rounded-full text-sm bg-orange-500 hover:bg-orange-600 duration-300 transition-all text-white font-medium flex items-center justify-center">
